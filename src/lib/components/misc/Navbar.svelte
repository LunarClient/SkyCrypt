...
<ScrollAreaPrimitive type="scroll" class="navbar group sticky! top-0 z-20 overflow-clip rounded-xl" data-pinned={pinned} bind:ref={navbarElement} orientation="horizontal">
